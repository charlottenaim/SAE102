...
def create_network(list_of_friends):
    """prenant en paramètre un tableau de couples d'amis et retournant le réseau associé.
    La construction du dictionnaire se fera en parcourrant une seule fois le tableau de couples d'amis.
    Pour chaque couple (p1, p2),  on ajoutera directement p2 à la liste des amis de p1 si ce dernier est une clé du dictionnaire.
    Sinon, on ajoutera dans le dictionnaire la clé p1 avec p2 comme seul ami. On procèdera de même avec p2.
    """
